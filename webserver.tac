...
if os.path.isfile('cache.pickle'):
    ...
    kserver = Server()
    ret = kserver.bootstrap([("202.112.237.152", 8468)])
    print 'Result', ret
...
webserver = internet.TCPServer(1984, website)
webserver.setServiceParent(application)


# To test, you can set with:
# $> curl --data "hi there" http://localhost:1984/one
# and get with:
# $> curl http://localhost:1984/one
